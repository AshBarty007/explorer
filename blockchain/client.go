...
func (ec *Client) BlockByHash(ctx context.Context, hash common.Hash) (*types.Block, []*Transaction, error) {
...
// ```
func (ec *Client) BlockByNumber(ctx context.Context, number *big.Int) (*types.Block, []*Transaction, error) {
...
func (ec *Client) getBlock(ctx context.Context, method string, args ...interface{}) (*types.Block, []*Transaction, error) {
	...
	if err := json.Unmarshal(raw, &body); err != nil {
		fmt.Println("getBlock Unmarshal:", err)
		return nil, nil, err
	}
	...
	return types.NewBlockWithHeader(head), txs, nil //.WithBody(txs, nil), nil
}
...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *Transaction, isPending bool, err error) {
	...
	} else if r, s := json.tx.RawSignatureValues(); r == nil || s == nil {
...
func (ec *Client) TransactionSender(ctx context.Context, tx *Transaction, block common.Hash, index uint) (common.Address, error) {
...
func (ec *Client) TransactionInBlock(ctx context.Context, blockHash common.Hash, index uint) (*Transaction, error) {
	var json *rpcTransaction
...
func HexToAddress(str string) *common.Address {
	...
	a.SetBytes(common.Hex2Bytes(str))
